...
[0-binary_to_uint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/bit_manipulation/0-binary_to_uint.c)
```sh
...
[1-print_binary.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/bit_manipulation/1-print_binary.c)
```sh
...
[2-get_bit.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/bit_manipulation/2-get_bit.c)
```sh
...
[3-set_bit.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/bit_manipulation/3-set_bit.c)
...
[4-clear_bit.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/bit_manipulation/4-clear_bit.c)
```sh
...
[5-flip_bits.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/bit_manipulation/5-flip_bits.c)
```sh
