...
The data structures used during this project is:
```sh
/**
...
[0-hash_table_create.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/hash_tables/0-hash_table_create.c)
```sh
...
[1-djb2.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/hash_tables/1-djb2.c)
```sh
...
[2-key_index.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/hash_tables/2-key_index.c)
```sh
...
[3-hash_table_set.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/hash_tables/3-hash_table_set.c)
```sh
...
[4-hash_table_get.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/hash_tables/4-hash_table_get.c)
```sh
...
[5-hash_table_print.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/hash_tables/5-hash_table_print.c)
```sh
...
[6-hash_table_delete.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/hash_tables/6-hash_table_delete.c)
```sh
...
==6621== ERROR SUMMARY: 0 errors from 0 c
```
