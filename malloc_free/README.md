...
[0-create_array.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/malloc_free/0-create_array.c)
```sh
...
[1-strdup.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/malloc_free/1-strdup.c)
...
[2-str_concat](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/malloc_free/2-str_concat.c)
...
[3-alloc_grid.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/malloc_free/3-alloc_grid.c)
```sh
...
[4-free_grid.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/malloc_free/4-free_grid.c)
```sh
