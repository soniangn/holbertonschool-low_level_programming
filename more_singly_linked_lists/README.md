...
The data structure used during this project is:
...
[0-print_listint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/0-print_listint.c)
```sh
...
[1-listint_len.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/1-listint_len.c)
```sh
...
[2-add_nodeint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/2-add_nodeint.c)
```sh
...
[3-add_nodeint_end.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/3-add_nodeint_end.c)
```sh
...
[4-free_listint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/4-free_listint.c)
```sh
...
[5-free_listint2.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/5-free_listint2.c)
```sh
...
[6-pop_listint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/6-pop_listint.c)
```sh
...
[7-get_nodeint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/7-get_nodeint.c)
```sh
...
[8-sum_listint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/8-sum_listint.c)
```sh
...
[9-insert_nodeint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/9-insert_nodeint.c)
```sh
...
[10-delete_nodeint.c](https://github.com/soniangn/holbertonschool-low_level_programming/blob/main/more_singly_linked_lists/10-delete_nodeint.c)
```sh
